...
type Querier interface {
	...
	CreateUserToRoleWithID(ctx context.Context, db DBTX, arg CreateUserToRoleWithIDParams) (UsersToRole, error)
	...
	GetLatestEventVersionForAggregate(ctx context.Context, db DBTX, arg GetLatestEventVersionForAggregateParams) (int64, error)
