...
func (r ScopeApiDeleteScopeRequest) Execute() (*Scope, *http.Response, error) {
...
//
//	@return Scope
func (a *ScopeApiService) DeleteScopeExecute(r ScopeApiDeleteScopeRequest) (*Scope, *http.Response, error) {
	var (
...
type ScopeApiListScopesForRoleRequest struct {
	ctx        context.Context
	ApiService *ScopeApiService
	id         int32
}

func (r ScopeApiListScopesForRoleRequest) Execute() ([]Scope, *http.Response, error) {
...
Returns a list of scopes for a role
	...
	@return ScopeApiListScopesForRoleRequest
*/
func (a *ScopeApiService) ListScopesForRole(ctx context.Context, id int32) ScopeApiListScopesForRoleRequest {
	return ScopeApiListScopesForRoleRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return []Scope
func (a *ScopeApiService) ListScopesForRoleExecute(r ScopeApiListScopesForRoleRequest) ([]Scope, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScopeApiService.ListScopesForRole")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
