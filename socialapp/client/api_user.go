...
type UserAPIWelcomeRequest struct {
	ctx        context.Context
	ApiService *UserAPIService
}

func (r UserAPIWelcomeRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.WelcomeExecute(r)
}
...
*/
func (a *UserAPIService) Welcome(ctx context.Context) UserAPIWelcomeRequest {
	return UserAPIWelcomeRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return string
func (a *UserAPIService) WelcomeExecute(r UserAPIWelcomeRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserAPIService.Welcome")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
