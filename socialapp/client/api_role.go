...
func (r RoleApiAddScopeToRoleRequest) Execute() ([]Scope, *http.Response, error) {
...
//
//	@return []Scope
func (a *RoleApiService) AddScopeToRoleExecute(r RoleApiAddScopeToRoleRequest) ([]Scope, *http.Response, error) {
	var (
