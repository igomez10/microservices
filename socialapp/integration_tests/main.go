...
func FollowLifeCycle(ctx context.Context) error {
	...
	func() {
		_, r1, err1 := apiClient.UserAPI.CreateUser(proxyCtx).
			...
			Execute()
		if err1 != nil {
			fmt.Printf("Error when calling `UserAPI.CreateUser`: %v\n %+v\n", err1, r1)
			panic(err1)
		}
	...
	func() {
		if err != nil {
			panic(fmt.Errorf("Error getting oauth2 context: %v", err))
		}
		r, err := apiClient.UserAPI.FollowUser(oauth2Ctx, username2, username1).Execute()
		if err != nil {
			panic(fmt.Errorf("Error when calling `UserAPI.FollowUser`: %v\n %+v\n", err, r))
		}
	}()
	...
	func() {
		...
		if len(followers) != 1 {
			panic(fmt.Errorf("Expected 1 follower, got %d", len(followers)))
		}
		if followers[0].Username != username1 {
			panic(fmt.Errorf("Expected follower %s, got %s", username1, followers[0].Username))
		}
	}()
	...
	func() {
		...
		if len(followers) != 0 {
			panic(fmt.Errorf("Expected 0 followers, got %d", len(followers)))
		}
	}()
	return nil
}
...
func GetExpectedFeed(ctx context.Context) error {
	...
	func() {
		_, r1, err1 := apiClient.UserAPI.
			...
			Execute()
		if err1 != nil {
			panic(fmt.Errorf("Error when calling `UserAPI.CreateUser`: %v\n %+v\n", err1, r1))
		}
	...
	func() {
		...
		_, r, err := apiClient.CommentAPI.
			...
			Execute()
		if err != nil {
			panic(fmt.Errorf("Error when calling `UserAPI.PostComment`: %v\n %+v\n", err, r))
		}
	}()
	...
	func() {
		feed, r, err := apiClient.CommentAPI.
			...
			Execute()
		if err != nil {
			panic(fmt.Errorf("Error when calling `UserAPI.GetUserFeed`: %v\n %+v\n", err, r))
		}
		if len(feed) != 1 {
			panic(fmt.Errorf("Expected 1 post in feed, got %d", len(feed)))
		}
		if feed[0].Username != username2 {
			panic(fmt.Errorf("Expected post from %s, got %s", username2, feed[0].Username))
		}
	}()
	...
	func() {
		...
		if len(feed) != 0 {
			panic(fmt.Errorf("Expected 0 post in feed, got %d: \n %+v", len(feed), feed))
		}
	}()
	return nil
}
...
func GetAccessToken(ctx context.Context) error {
	...
	func() {
		_, _, err := apiClient.UserAPI.CreateUser(proxyCtx).CreateUserRequest(*createUsrReq).Execute()
		if err != nil {
			panic(fmt.Errorf("Error creating user: %v", err))
		}
	}()
	scopes := []string{
		"socialapp.users.read",
	...
	if err != nil {
		panic(fmt.Errorf("Error when calling `AuthenticationAPI.GetAccessToken`: %v", err))
	}
	// assert scopes are correct
	if res.Status != "200 OK" {
		panic(fmt.Errorf("Expected status 200, got %s", res.Status))
	}

	if len(token.Scopes) != len(scopes) {
		log.Info().Strs("got_scopes", token.Scopes).Strs("expected_scopes", scopes).Msg("Scopes")
		panic(fmt.Errorf("Expected %d scopes, got %d", len(scopes), len(token.Scopes)))
	}
	return nil
}
...
func RegisterUserFlow(ctx context.Context) error {
	...
	if err != nil {
		panic(fmt.Errorf("Error when calling `UserAPI.CreateUser`: %v", err))
	}

	if res.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
	}
	...
	func() {
		...
		if err != nil {
			panic(fmt.Errorf("Error when calling `UserAPI.GetUsers`: %v", err))
		}
		if res.StatusCode != http.StatusOK {
			panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
		}
	...
	func() {
		...
		if res.StatusCode != http.StatusForbidden { // TOOD fix to 401
			panic(fmt.Errorf("Expected status code 401, got %d", res.StatusCode))
		}
		if user != nil {
			panic(fmt.Errorf("Expected nil user, got %v", user))
		}
	}()
	return nil
}
...
func ChangePassword(context.Context) error {
	...
	if res.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code 201, got %d", res.StatusCode))
	}
	...
	func() {
		...
		if err != nil {
			panic(fmt.Errorf("Error when calling `UserAPI.ChangePassword`: %v", err))
		}
		if res.StatusCode != http.StatusOK {
			panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
		}
	...
	// 	}
	// 	if token != nil {
	// 	panic(fmt.Errorf("Expected nil user, got %v", token))
	// 	}
	// }()
	...
	func() {
		...
		if token == nil {
			panic(fmt.Errorf("Expected token, got nil"))
		}
	}()
	return err
}
...
func RoleLifecycle(ctx context.Context) error {
	...
	if err != nil {
		panic(fmt.Errorf("Error when calling `RoleAPI.CreateRole`: %v", err))
	}
	if res.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
	}
	...
	if err != nil {
		panic(fmt.Errorf("Error when calling `RoleAPI.GetRole`: %v", err))
	}
	if res.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
	}
	if gettedRole == nil {
		panic(fmt.Errorf("Expected role, got nil"))
	}
	...
	func() {
		...
		if err != nil {
			panic(fmt.Errorf("Error when calling `ScopeAPI.CreateScope`: %v", err))
		}
		if res.StatusCode != http.StatusOK {
			panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
		}
		...
		if err != nil {
			panic(fmt.Errorf("Error when calling `RoleAPI.AddScopeToRole`: %v", err))
		}
		...
		if err != nil {
			panic(fmt.Errorf("Error when calling `RoleAPI.ListScopesForRole`: %v", err))
		}
		if res.StatusCode != http.StatusOK {
			panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
		}
		if len(roleScopes) != 1 {
			panic(fmt.Errorf("Expected 1 scope, got %d", len(roleScopes)))
		}
		if roleScopes[0].Name != newScope.Name {
			panic(fmt.Errorf("Expected scope name %s, got %s", newScope.Name, roleScopes[0].Name))
		}
		...
		if err != nil {
			panic(fmt.Errorf("Error when calling `RoleAPI.RemoveScopeFromRole`: %v", err))
		}
		if res.StatusCode != http.StatusNoContent {
			panic(fmt.Errorf("Expected status code 204, got %d", res.StatusCode))
		}
		...
		if len(roleScopes) != 0 {
			panic(fmt.Errorf("Expected 0 scopes, got %d", len(roleScopes)))
		}
		...
		if err != nil {
			panic(fmt.Errorf("Error when calling `ScopeAPI.DeleteScope`: %v", err))
		}
		if res.StatusCode != http.StatusOK {
			panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
		}
	...
	if err != nil {
		panic(fmt.Errorf("Error when calling `RoleAPI.UpdateRole`: %v", err))
	}
	if res.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
	}
	...
	if updatedRole.Name != updatedName {
		panic(fmt.Errorf("Expected name %s, got %s", updatedName, updatedRole.Name))
	}
	if *updatedRole.Description != updatedDesc {
		panic(fmt.Errorf("Expected description %s, got %s", updatedDesc, *updatedRole.Description))
	}
	...
	if gettedRole.Name != updatedName {
		panic(fmt.Errorf("Expected name %s, got %s", updatedName, gettedRole.Name))
	}
	if *gettedRole.Description != updatedDesc {
		panic(fmt.Errorf("Expected description %s, got %s", updatedDesc, *gettedRole.Description))
	}
	...
	func() {
		...
		if err != nil {
			panic(fmt.Errorf("Error when calling `RoleAPI.DeleteRole`: %v", err))
		}
		if res.StatusCode != http.StatusOK {
			panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
		}
	...
	if err == nil {
		panic(fmt.Errorf("Expected error when calling `RoleAPI.GetRole`, got nil"))
	}
	if res.StatusCode != http.StatusNotFound {
		panic(fmt.Errorf("Expected status code 404, got %d", res.StatusCode))
	}
	if gettedDeletedRole != nil {
		panic(fmt.Errorf("Expected nil, got %v", gettedRole))
	}
	return nil
}
...
func ScopeLifecycle(ctx context.Context) error {
	...
	if err != nil {
		panic(fmt.Errorf("Error when calling `ScopeAPI.GetScope`: %v", err))
	}
	if res.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
	}
	if gettedScope == nil {
		panic(fmt.Errorf("Expected scope, got nil"))
	}
	...
	if err != nil {
		panic(fmt.Errorf("Error when calling `ScopeAPI.UpdateScope`: %v", err))
	}
	if res.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
	}
	...
	if updatedScope.Name != updatedName {
		panic(fmt.Errorf("Expected name %s, got %s", updatedName, updatedScope.Name))
	}
	if updatedScope.Description != updatedDesc {
		panic(fmt.Errorf("Expected description %s, got %s", updatedDesc, updatedScope.Description))
	}
	...
	if gettedScope.Name != updatedName {
		panic(fmt.Errorf("Expected name %s, got %s", updatedName, gettedScope.Name))
	}
	if gettedScope.Description != updatedDesc {
		panic(fmt.Errorf("Expected description %s, got %s", updatedDesc, gettedScope.Description))
	}
	...
	if err == nil {
		panic(fmt.Errorf("Expected error when calling `ScopeAPI.GetScope`, got nil"))
	}
	if res.StatusCode != http.StatusNotFound {
		panic(fmt.Errorf("Expected status code 404, got %d", res.StatusCode))
	}
	if gettedDeletedScope != nil {
		panic(fmt.Errorf("Expected nil, got %v", gettedScope))
	}
	return nil
}

func UserRoleLifeCycle(ctx context.Context) error {
	Setup()
	configuration := NewDefaultConfiguration(WithSkipCache())
	httpClient := getHTTPClient()
	configuration.HTTPClient = httpClient
	...
	if err != nil {
		panic(fmt.Errorf("Error when calling `UserAPI.UpdateRolesForUser`: %v", err))
	}
	...
	if err != nil {
		panic(fmt.Errorf("Error when calling `UserAPI.GetRolesForUser`: %v", err))
	}
	if res.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code 200, got %d", res.StatusCode))
	}
	...
	if !foundRole {
		panic(fmt.Errorf("Expected to find role %s, got %v", createdRole.Name, roles))
	}
...
func CacheRequestSameUser(ctx context.Context) error {
	...
	if err != nil {
		...
		panic(fmt.Errorf("Error when calling `UserAPI.ListUsers`: %v\n", err))
	}
	if r.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code %d, got %d", http.StatusOK, r.StatusCode))
	}
	...
	for _, currentUser := range listedUsers {
		for i := 0; i < 50; i++ {
			...
			if err != nil {
				log.Info().Msgf("Full HTTP Response: %v\n", r)
				panic(fmt.Errorf("Error when calling `UserAPI.GetUser`: %v\n", err))
			...
			if err != nil {
				log.Info().Msgf("Full HTTP Response: %v\n", r)
				panic(fmt.Errorf("Error when calling `CommentAPI.GetUserComments`: %v\n", err))
			...
			if err != nil {
				log.Info().Msgf("Full HTTP Response: %v\n", r)
				panic(fmt.Errorf("Error when calling `CommentAPI.GetUserFeed`: %v\n", err))
...
func URLLifeCycle(ctx context.Context) error {
	...
	if err != nil {
		...
		panic(fmt.Errorf("Error when calling `URLAPI.CreateURL`: %v\n", err))
	}
	...
	if err != nil {
		log.Err(err).Msgf("Full HTTP Response: %v\n", getUrlRes)
		panic(fmt.Errorf("Error when calling `URLAPI.GetURL`: %v\n", err))
	}

	if getUrlRes.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code %d, got %d", http.StatusOK, getUrlRes.StatusCode))
	}
	...
	if err != nil {
		log.Err(err).Msgf("Full HTTP Response: %v\n", deleteUrlRes)
		panic(fmt.Errorf("Error when calling `URLAPI.DeleteURL`: %v\n", err))
	}

	if deleteUrlRes.StatusCode != http.StatusOK {
		panic(fmt.Errorf("Expected status code %d, got %d", http.StatusOK, deleteUrlRes.StatusCode))
	}

	// get url
	getUrlRes, err = apiClient.URLAPI.GetUrl(proxyCtx, newURL.Alias).Execute()
	if err == nil {
		panic(fmt.Errorf("Expected error when calling `URLAPI.GetURL`, got none"))
	}
	if getUrlRes.StatusCode != http.StatusNotFound {
		panic(fmt.Errorf("Expected status code %d, got %d", http.StatusNotFound, getUrlRes.StatusCode))
	}
